            ...
            <div class="card-body p-0">
                ...
                <ul class="dashboard-tabs nav nav-pills nav-danger row row-paddingless m-0 p-0 flex-column flex-sm-row" role="tablist">
                    ...
                    <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                        <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center {{ Route::is('home') ? 'active' : '' }}"  href="{{route('home')}}">
                    ...
                    <!-- Perpustakaan -->
                    <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                        <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center {{ Route::is('perpustakaan.index') || Route::is('perpustakaan.create') || Route::is('perpustakaan.create-admin') || Route::is('perpustakaan.show') ? 'active' : '' }}"  href="{{route('perpustakaan.index')}}">
															<span class="nav-icon py-2 w-auto">
																<span class="svg-icon svg-icon-3x">
                            ...
                            <span class="nav-text font-size-lg py-2 font-weight-bolder text-center">Ruang Perpustakaan</span>
                        </a>
                    </li>
                    <!-- end::Perpustakaan -->
                    ...
                    <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                        <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center {{ Route::is('aula.show') || Route::is('aula.index')  || Route::is('aula.create') || Route::is('aula.create-admin') ? 'active' : '' }}"  href="{{route('aula.index')}}">
															<span class="nav-icon py-2 w-auto">
																<span class="svg-icon svg-icon-3x">
                            ...
                            <span class="nav-text font-size-lg py-2 font-weight-bolder text-center">Ruang Aula</span>
                        </a>
                    </li>

                    <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                        <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center {{ Route::is('laktasi.show') || Route::is('laktasi.index')  || Route::is('laktasi.create') || Route::is('laktasi.create-admin') ? 'active' : '' }}"  href="{{route('laktasi.index')}}">
                            <span class="nav-icon py-2 w-auto">
																<span class="svg-icon svg-icon-3x">
                            ...
                            <span class="nav-text font-size-lg py-2 font-weight-bolder text-center"> Ruang Laktasi</span>
                        </a>
                    </li>

                    <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                        <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center {{ Route::is('bulu-tangkis.show') || Route::is('bulu-tangkis.index')  || Route::is('bulu-tangkis.create') || Route::is('bulu-tangkis.create-admin') ? 'active' : '' }}"  href="{{route('bulu-tangkis.index')}}">
															<span class="nav-icon py-2 w-auto">
                                                                <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo5\dist/../src/media/svg/icons\Tools\Pantone.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="nav-text font-size-lg py-2 font-weight-bolder text-center"> Lapangan Bulu Tangkis</span>
                        </a>
                    </li>

                    <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-0 mb-3 mb-lg-0">
                        <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center {{ Route::is('futsal.show') || Route::is('futsal.index')  || Route::is('futsal.create') || Route::is('futsal.create-admin') ? 'active' : '' }}"   href="{{route('futsal.index')}}">
                                                        <span class="nav-icon py-2 w-auto">
																<span class="svg-icon svg-icon-3x">
                            ...
                            <span class="nav-text font-size-lg py-2 font-weight-bolder text-center">Lapangan Futsal</span>
                        </a>
                    </li>
